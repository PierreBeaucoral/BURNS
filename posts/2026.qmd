...
`r if (is.na(pct_vs_med)) "not yet comparable to the median (too early in the season for a meaningful ratio)" else sprintf("running above the median (about %.1f times it)", pct_vs_med / 100)` and now
near the top of the band: of the last nine seasons, only 2025 was further along
at this date. My honest reading has hardened to *the second-worst start in a
decade, behind only 2025*. That order is new: through late July it was 2022 that
led, but 2025 burned violently in early August and has pulled well ahead, while
2026 has edged past 2022 into second by a margin thin enough to change again.
Most of a European fire season happens in July and
August. This line has most of its story still ahead of it, and I will not call
a season in week ten.
